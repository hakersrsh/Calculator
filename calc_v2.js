...
function drop(e) {
    if(e){
       console.log(e);
        ...
        // let ele = document.getElementById("showBtnLayer");
        ...
        if(document.getElementById(data).classList.contains("SQUARE")){
       ...
       console.log(document.getElementById(data).classList);
        ...
        document.getElementById('showBtn').appendChild(document.getElementById(data));
    }
};
